    ...
    <div className="App">
      ...
      <div>
        ...
        <div>
            ...
            <h3>2022 Dec - 2023 Mar | C# Developer</h3>
            <p>I know everything needed to make a website function, efficient. I didn't stop with the web. I went beyond with most popular Back-end framework called Laravel.I even know the deployment, server and security. I will give you 100% web solution.</p>
        </div>
    
    
    <footer>
        <p><small>© Thayu 2024, Full Stack Developer</small></p>
    </footer>
